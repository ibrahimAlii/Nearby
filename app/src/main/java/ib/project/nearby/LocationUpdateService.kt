...
class LocationUpdatesService : Service() {
    ...
    val notification: Notification
        get() {
            ...
            val activityPendingIntent = PendingIntent.getActivity(
                this, 0,
                Intent(this, NearbyActivity::class.java), 0
            )

            val builder = NotificationCompat.Builder(this)
                .addAction(
                    android.R.drawable.ic_media_play, getString(R.string.open_app),
    ...
    override fun onUnbind(intent: Intent): Boolean {
        ...
        if (!mChangingConfiguration && LocationUtils.locationRequestUpdate) {
    ...
    fun requestLocationUpdates() {
        ...
        LocationUtils.locationRequestUpdate = true
        ...
        try {
            ...
            LocationUtils.locationRequestUpdate = false
    ...
    companion object {
        ...
        private val PACKAGE_NAME =
            "ib.project.nearby.locationupdatesforegroundservice"
